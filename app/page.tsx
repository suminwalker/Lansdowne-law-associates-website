  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container px-4 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center space-y-4 p-6 rounded-lg bg-slate-50 border border-slate-100">
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="container px-4 mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            {/* More */}
            <Card className="bg-primary/5 border-none flex flex-col justify-center items-center text-center">
      ...
      <section className="py-24 bg-primary text-primary-foreground">
        <div className="container px-4 text-center space-y-8 mx-auto max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a href="tel:610-623-3445" className="text-2xl font-bold hover:underline">
              (610) 623-3445
            </a>
          </div>
        </div>
